...
if 'access_token' in validate_result:
    ...
    result = requests.get("http://localhost:5000/cause/scope_of_bee/find", params=data)
    bee_cause_by_scope_result = result.json()
    print "=========================="
    print "=======TEST RESULT========"
    print "=========================="
    print bee_cause_by_scope_result
