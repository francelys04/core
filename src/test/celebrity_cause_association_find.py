...
'''
#===============================================================================
# TEST CELEBRITIES ASSOCIATED OR NO TO ONE CAUSE (OPTIONAL FILTER BY NAME)
#===============================================================================
...
global_name_filter = ""
global_associated = 'False' #Required: True or False
...
if 'access_token' in validate_result:
    ...
    result = requests.get("http://localhost:5000/celebrity/cause_association/find", params=data)
